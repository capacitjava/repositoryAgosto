...
public class ActionRegister extends ActionSupport implements ModelDriven<Register> {
	...
	private Register register = new Register(); //GET Y SET
	private DaoRegister dao = new DaoImplRegister();
	private List<Register> listRegisters = new ArrayList<Register>(); //GET Y SET
	...
	//GET AND SET OF REGISTER AND LISTREGISTERS
